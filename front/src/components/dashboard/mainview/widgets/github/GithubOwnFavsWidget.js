...
const GithubOwnFavsWidget = ({ widget, fetchUserWidgets }) => {
  ...
  return repos && repos.length !== 0 ? (
    ...
    <Widget widget={widget} fetchUserWidgets={fetchUserWidgets}>
      <div className={'flex text-center mx-auto text-gray-800'}>
        <p>
          Vous n&apos;avez pas de dépôts en favoris ou il y a eu une erreur lors
          de la requête.
        </p>
      </div>
    </Widget>
...
export default GithubOwnFavsWidget;
